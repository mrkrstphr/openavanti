 ...
 */
     ...
     * @author      Kristopher Wilson
     * @package     openavanti
     * @link        http://www.openavanti.com/documentation/docs/1.0.3/CRUD 
     */
    class CRUD implements Iterator
    {
         ...
         *       
         * @param string $sTableName The name of the database table
         * @param mixed $oData An array or object of data to load into the CRUD object       
         * @return void
         */
         ...
         *
         * @param mixed $xId The ID of the data being found
         * @param array $aClauses Additional databases clauses, including: join, where, order, offset and
         ...
         *
         * @param array $aClauses Additional databases clauses, including: join and where. Where is a string
         ...
         *
         * @param string $sColumn The name of the column we are pulling records by. This name may 
         *  underscores removed and be cased differently         
         * @param string $sValue The value of the column in the first argument that determines which
         *  records will be selected
         * @param string $sOrder Optional; The order clause for the query
         ...
         * @throws Exception, QueryFailedException                                       
         *
         * @param string $sColumn  The name of the column we are basing our delete from. This name may
         *  underscores removed and be cased differently         
         * @param string $sValue The value of the column in the first argument that determines which
         ...
         * an array or object.
         *               
         * @param mixed $oRecord The data to load into the CRUD object
         * @return void
         */
         ...
         * 
         * @throws Exception
         * @param string $sName The name of the column to set
         * @param string $sValue The value to set the column specified in the first argument
         * @return void
         */ 
         ...
         * update the value.
         * 
         * @param string $sName The name of the database column to unset
         * @return void
         */ 
         ...
         *
         * @throws Exception
         * @param string $sName The name of the argument to be called magically 
         * @param array $aArguments An array of arguments to pass to the magically called method
         * @return mixed The return value of the method being called
         */
         ...
         *          
         * @param bool $bIncludeReferences Optional; Should this returned XML include 
         *      references? Default false.
         * @param bool $bProvideAll Optional; Should this returned XML include all records 
         ...
         *
         * @param bool $bIncludeReferences Optional; Toggles whether references/relationships should be 
         *      stored in the JSON string. Default: false
