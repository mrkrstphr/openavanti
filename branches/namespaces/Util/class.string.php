 ...
 */
    ...
    class String
    {
         ...
         *
         * @param string the singular word to attempt to make plural
         ...
         *
         * @param string the plural word to attempt to make singular
         ...
         *
         * @param string|array Either the singular form of the word, or an array of 
         *      single => plural
         * @param string Optional; Either the plural form of the word or null if an array was
         *      passed for the first argument
         * @return array A copy of the dictionary
         */
         ...
         * supplied delimiter.        
         *
         * @param string The string we're generating a substring from
         * @param string The delimiter that we're searching for
