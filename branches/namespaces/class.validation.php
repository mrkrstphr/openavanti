 ...
 */
    ...
    {       
         ...
         *
         * @param string The name of the field to check for errors on         
         ...
         * 
         * @param string The name of the form field the error occurred on
         ...
         * @param string The data to validate against
         ...
         * @param string The name of the field being validated
         * @param string The data to validate against
         * @param integer The minimum number of characters the supplied data must be in length to 
         *       pass validation
         * @param string Optional, the message to store in the list of validation errors if 
         *       validation fails
         * @return boolean True if the data passes validation, false otherwise                                                                 
         ...
         * @param string The name of the field being validated
         * @param string The data to validate against
         * @param integer The maximum number of characters the supplied data must not surpass in 
         ...
         * 
         * @param string The name of the file field to validate
         * @param string Optional, the message to store in the list of validation errors if 
         *       validation fails           
         * @return boolean True if the data passes validation, false otherwise                                                                 
         */
         ...
         * 
         * @param string The name of the file field to validate
         * @param string The name of the uploaded temporary file      
         * @param array An array of file extensions that are valid for the uploaded file       
         * @param string Optional, the message to store in the list of validation errors if 
         *       validation fails           
         * @return boolean True if the data passes validation, false otherwise                                                                 
         */
         ...
         * 
         * @param string The name of the file field to validate
         * @param integer The maximum size the file is allowed to be     
         * @param string Optional, the message to store in the list of validation errors if 
         *       validation fails           
         * @return boolean True if the data passes validation, false otherwise                                                                 
         */
         ...
         * @param string The name of the field being validated
         * @param string The data to validate against
         * @param string The regular expression to match against the supplied data
         * @param string The message to store in the list of validation errors if 
         *       validation fails
