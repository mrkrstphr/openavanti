...
class Validation
{
     ...
     *
     */
    private static $_logErrors = true;
     ...
     */
    public static function fieldHasErrors($field)
    {
        return isset(self::$_errorList[$field]);
    ...
    {
        if(!is_null($field) && self::fieldHasErrors($field))
            return self::$_errorList[$field];
    ...
    */
     ...
     *
     */
    public static function validateReCaptcha($privateKey, $challenge, $response, $message = 'ReCaptcha response is incorrect')
    {
        $recaptcha = new \OpenAvanti\Service\ReCaptcha(null, $privateKey);

        if(!$recaptcha->verifyResponse($challenge, $response))
        {
            self::setError('recaptcha', $message);
            return false;
        }
