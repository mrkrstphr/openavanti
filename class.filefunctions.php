 ...
 */
     ...
     * @author      Kristopher Wilson
     * @package     openavanti
     * @link        http://www.openavanti.com/documentation/docs/1.0.3/FileFunctions
     */
    class FileFunctions
    {
        ...
        /**
         * Similar to CreateFileNameFrom(), this method also accepts a string to append to the
         * timestamp in order to help ensure a more unique name when files are created at the
         * exact same time, or in rapid succession.
         *          
         * @param string $sBase The name of the original file, used to get the file extension         
         * @param string $sString The string to add to the time to ensure a more unique name
         ...
         * 
         * @param string $sTmpFile The absolute path to the temp file uploaded via _FILES
         * @param string $sUploadName The name of the uploaded file to determine the file extension
         * @param string $sDirectory The path to the directory to store the new file
         ...
         *
         * @param string $sFileName The file name to attempt to find in the include path
         ...
         *
         * @param integer $iSizeInBytes The file size in bytes
         ...
         *  
         * @param string $sPath The name of the directory to remove (recursively)         
         ...
         *       
         * @param string $sOldDirectory The directory to recursively move
         * @param string $sNewDirectory The new directory to move the old directory to               
